...
![Создание и исполнение файла](image/6.png){#fig:006 width=70%}
...
выдаёт псевдослучайные числа в диапазоне от 0 до 32767, ввожу ограничения так, чтобы была генерация чисел от 1 до 26 (рис. @fig:007).
